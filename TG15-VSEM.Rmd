...
## Plot results
```{r fig.height=4, fig.cap="Output from perfect model after calibration"}
...
## Plot results
```{r , fig.height=4, fig.cap="Output from perfect model with unbalanced obs after calibration"}
par(mfrow = c(2,2))
plotTimeSeriesResults(x = out, model = runModel1, observed = obs[,1], error = errorFunction)
plotTimeSeriesResults(x = out, model = runModel2, observed = obs[,2], error = errorFunction)
plotTimeSeriesResults(x = out, model = runModel3, observed = obs[,3], error = errorFunction)
...
## Plot results
```{r fig.height=4, fig.cap="Output from model with error with 1000 balanced obs after calibration"}
par(mfrow = c(2,2))
plotTimeSeriesResults(x = out, model = runModel1, observed = obs[,1], error = errorFunction)
plotTimeSeriesResults(x = out, model = runModel2, observed = obs[,2], error = errorFunction)
plotTimeSeriesResults(x = out, model = runModel3, observed = obs[,3], error = errorFunction)
...
## Plot results
```{r  fig.height=4, fig.cap="Output from model with error with six balanced obs after calibration"}
par(mfrow = c(2,2))
plotTimeSeriesResults(x = out, model = runModel1, observed = obs[,1], error = errorFunction)
plotTimeSeriesResults(x = out, model = runModel2, observed = obs[,2], error = errorFunction)
plotTimeSeriesResults(x = out, model = runModel3, observed = obs[,3], error = errorFunction)
...
## Plot results
```{r fig.height=4, fig.cap="Output from model with error with unbalanced obs after calibration"}
par(mfrow = c(2,2))
plotTimeSeriesResults(x = out, model = runModel1, observed = obs[,1], error = errorFunction)
plotTimeSeriesResults(x = out, model = runModel2, observed = obs[,2], error = errorFunction)
plotTimeSeriesResults(x = out, model = runModel3, observed = obs[,3], error = errorFunction)
